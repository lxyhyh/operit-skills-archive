...
归档中的技能来源已混乱不清，无法精确区分原创与改编。已知其中部分技能改编自知名 Skills 作者 [mattpocock](https://github.com/mattpocock) 的 [skills](https://github.com/mattpocock/skills) 仓库，经中文翻译与 Operit 平台本地化适配，**版权归原作者所有**；其余技能为本地环境长期积累，具体来源与原创归属无法逐一确认。

## Visibility（可见性）

仓库当前为 **Public（公开）**。维护建议：

- **版权**：部分技能改编自第三方（见上节），版权归原作者所有，再分发前应确认所依据的原始许可证条款允许。
- **隐私与凭据**：确认文档中不含本地路径、个人信息或有效凭据。
- **平台规范**：确认 Operit 平台对技能文档公开分发的约束（如有）。
